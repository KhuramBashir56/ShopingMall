    ...
    Route::middleware('can:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('products')->name('products.')->group(function () {
            Route::prefix('units')->name('units.')->group(function () {
                Route::get('list', App\Livewire\Panel\Admin\ProductManagement\Units\Index::class)->name('list');
                Route::get('create', App\Livewire\Panel\Admin\ProductManagement\Units\Create::class)->name('create');
                Route::get('{unit_id}/details', App\Livewire\Panel\Admin\ProductManagement\Units\Details::class)->name('details');
                Route::get('{unit_id}/edit', App\Livewire\Panel\Admin\ProductManagement\Units\Edit::class)->name('edit');
            });
